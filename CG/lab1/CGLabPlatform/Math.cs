...
namespace CGLabPlatform
{
    ...
    public struct DMatrix3 : ICloneable, IEquatable<DMatrix3>, IFormattable
    {
        ...
        public double[] ToArray() {
            return new double[9] { M11, M12, M13, M21, M22, M23, M31, M32, M33 };
	    }
    ...
    public struct DMatrix4 : ICloneable, IEquatable<DMatrix4>, IFormattable
    {
        ...
        public double[] ToArray() {
            return new double[16] { M11, M21, M31, M41, M12, M22, M32, M42, M13, M23, M33, M43, M14, M24, M34, M44 };
            //return new double[16] { M11, M12, M13, M14, M21, M22, M23, M24, M31, M32, M33, M34, M41, M42, M43, M44 };
	    }
		...
		public double this[int row, int column] {
			get { return this[(row-1) * 4 + (column-1)]; }
			set { this[(row-1) * 4 + (column-1)] = value; }
		}
